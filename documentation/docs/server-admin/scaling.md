...
[The parts of the grid are:](#gridParts)
...
*   ERDDAP's [flag system](https://erddap.github.io/setup.html#flag)  
    ...
     
*   ERDDAP's ["files" system](/erddap/files/documentation.html)  
